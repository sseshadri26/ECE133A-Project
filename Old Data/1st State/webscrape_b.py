...
# Read the CSV file
with open("all_games2.csv", "r+", encoding='utf-8') as file:
...
with open("updated_games_b.csv", "w", newline="", encoding='utf-8') as output_file:
...
with open("updated_games_b.csv", "r", encoding='utf-8') as file:
    reader = csv.reader(file)
...
with open("updated_games2_b.csv", "w", newline="", encoding='utf-8') as file:
