...
# Read the CSV file
with open("leftovers.csv", "r+", encoding='utf-8') as file:
...
with open("updated_gamesleftovers.csv", "w", newline="", encoding='utf-8') as output_file:
...
with open("updated_gamesleftovers.csv", "r", encoding='utf-8') as file:
    reader = csv.reader(file)
...
with open("updated_games2leftovers.csv", "w", newline="", encoding='utf-8') as file:
