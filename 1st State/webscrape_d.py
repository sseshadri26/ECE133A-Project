...
# Read the CSV file
with open("all_games4.csv", "r+", encoding='utf-8') as file:
...
with open("updated_games_d.csv", "w", newline="", encoding='utf-8') as output_file:
...
with open("updated_games_d.csv", "r", encoding='utf-8') as file:
    reader = csv.reader(file)
...
with open("updated_games2_d.csv", "w", newline="", encoding='utf-8') as file:
